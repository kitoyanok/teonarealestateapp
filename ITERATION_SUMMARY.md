...
- Git version for this iteration: `v0.1.12`
- Branch: `main`
...
- мини-графики в KPI приведены ближе к целевому референсу:
  - все KPI теперь рисуются оранжевыми sparkline-линиями
  - линии строятся по реальным накопленным значениям за 7 дней
...
- все KPI-плашки на главной теперь используют одинаковые оранжевые line-графики
- графики KPI строятся по накопленным реальным значениям за 7 дней:
  - клиенты в работе
  - найденные объекты
  - объекты в подборках
  - готовые к отправке подборки
- KPI-плашки визуально приведены к референсу: крупное число, реальный тренд, большой sparkline-график и подпись снизу
