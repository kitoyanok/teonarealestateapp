...
- Git version for this iteration: `v0.1.10`
- Branch: `main`
...
- мини-графики в KPI приведены ближе к целевому референсу:
  - `Найдено объектов` теперь рисуется sparkline-линией
  - остальные KPI показывают реальные столбики по дням
