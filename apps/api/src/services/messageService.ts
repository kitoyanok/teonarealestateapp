// Этот файл собирает текст подборки для клиента.
// Проще говоря: он превращает выбранные объекты в готовое сообщение, которое риелтор может скопировать и отправить.
